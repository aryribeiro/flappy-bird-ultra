...
- **3 vidas (❤️ x3 no topo).** Bater num cano, inimigo ou no chão gasta uma vida: o pássaro volta ao meio da tela piscando, invencível por 3 s, e **o tiro volta ao PIPOCO** — as moedas ficam, mas as armas precisam ser compradas de novo. A cada 2 minutos de partida aparece **um coração à venda por $30** (mais caro que qualquer arma) que recupera uma vida (máx. 3) — sem saldo, ele passa. O **ESCUDO** absorve uma colisão — com inimigo *ou* com cano.
